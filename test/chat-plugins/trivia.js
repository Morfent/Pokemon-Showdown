...
describe('Trivia', function () {
	...
	context('first mode', function () {
		beforeEach(function () {
			let questions = [{question: '', answers: ['answer'], category: 'ae'}];
			let FirstModeTrivia = trivia.firstModeDecorator(Trivia);
	...
	context('timer mode', function () {
		beforeEach(function () {
			let questions = [{question: '', answers: ['answer'], category: 'ae'}];
			let TimerModeTrivia = trivia.timerModeDecorator(Trivia);
	...
	context('number mode', function () {
		beforeEach(function () {
			let questions = [{question: '', answers: ['answer'], category: 'ae'}];
			let NumberModeTrivia = trivia.numberModeDecorator(Trivia);
